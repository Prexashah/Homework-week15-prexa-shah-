...
public class AddUserPage extends Utility {
    ...
    public void clickUserRoleDropDown(String text) {
        selectByVisibleTextFromDropDown(userRoleSelectDropDown,text);
    }
    ...
    public void clickOnEmployeeNameTextBox(String text) {
